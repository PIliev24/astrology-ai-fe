          ...
          <Link key={house.slug} href={`/houses/${house.slug}`}>
            <Card className="h-full hover:zodiac-glow transition-all duration-300 hover:scale-[1.02] bg-card backdrop-blur">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-sm text-foreground/85 line-clamp-2">{house.description.slice(0, 120)}...</p>
              </CardContent>
            </Card>
          </Link>
        ))}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="bg-card">
            ...
            <CardContent className="space-y-3">
              <p className="text-foreground/85">The most powerful houses, marking cardinal points in your chart:</p>
          ...
          <Card className="bg-card">
            ...
            <CardContent className="space-y-3">
              <p className="text-foreground/85">Houses of resources and values following the angular houses:</p>
              <ul className="space-y-2 text-sm">
                <li>
          ...
          <Card className="bg-card md:col-span-2">
            ...
            <CardContent className="space-y-3">
              <p className="text-foreground/85">Houses of learning, adaptation, and mental processes:</p>
