...
const LoginForm = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 w-32 h-32 bg-celestial-violet/20 rounded-full blur-3xl animate-nebula-drift" />
      <div
        className="absolute bottom-20 right-10 w-40 h-40 bg-celestial-gold/15 rounded-full blur-3xl animate-nebula-drift"
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="h-12 bg-card border-border focus:border-celestial-gold focus:ring-celestial-gold/20 transition-all"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          disabled={isSubmitting}
                          className="h-12 bg-card border-border focus:border-celestial-gold focus:ring-celestial-gold/20 pr-12 transition-all"
                          {...field}
                        />
                        <button
                          type="button"
