...
export const HOUSES: AstrologicalHouse[] = [
  {
    ...
    rulingSign: "Aries",
    rulingPlanet: "Mars",
    description: "The First House represents your outward personality, physical appearance, and the way you present yourself to the world. It's the house of new beginnings and how others perceive you at first meeting. This house sets the tone for your entire birth chart.",
  ...
  },
  {
    ...
    rulingSign: "Taurus",
    rulingPlanet: "Venus",
    description: "The Second House governs your material resources, personal finances, and sense of self-worth. It reveals your attitudes toward money, possessions, and what you truly value in life. This house shows how you earn, spend, and manage your resources.",
  ...
  },
  {
    ...
    description: "The Third House rules communication, early education, siblings, and your immediate environment. It governs how you think, learn, and express ideas. This house also covers short-distance travel and your relationship with neighbors and your community.",
    lifeAreas: ["Communication style", "Siblings", "Neighbors", "Early education", "Short journeys", "Writing"],
    questions: ["How do I communicate?", "What is my learning style?", "How do I connect with my immediate environment?"],
  },
  {
    number: 4,
    slug: "fourth-house",
    ...
    rulingSign: "Cancer",
    rulingPlanet: "Moon",
    description: "The Fourth House represents your home, family, roots, and emotional foundation. It governs your relationship with your parents (especially the mother figure), your ancestry, and your sense of belonging. This house shows your private life and what makes you feel secure.",
  ...
  },
  {
    ...
    rulingSign: "Leo",
    rulingPlanet: "Sun",
    description: "The Fifth House is the house of creativity, romance, pleasure, and self-expression. It governs artistic pursuits, hobbies, love affairs, and your relationship with children. This house reveals how you express your creativity and what brings you joy.",
  ...
  },
  {
    ...
    rulingSign: "Virgo",
    rulingPlanet: "Mercury",
    description: "The Sixth House governs your daily routines, work environment, health habits, and service to others. It reveals your approach to wellness, your relationship with coworkers, and how you handle day-to-day responsibilities. This house also relates to pets and small animals.",
  ...
  },
  {
    ...
    rulingSign: "Libra",
    rulingPlanet: "Venus",
    description: "The Seventh House is the house of partnerships, marriage, and one-on-one relationships. It reveals what you seek in a partner, how you approach committed relationships, and your style of cooperation. This house also governs business partnerships and legal contracts.",
  ...
  },
  {
    ...
    rulingSign: "Scorpio",
    rulingPlanet: "Pluto",
    description: "The Eighth House governs transformation, shared resources, intimacy, and the cycle of death and rebirth. It reveals your approach to deep emotional bonds, inheritance, taxes, and other people's money. This mysterious house also relates to occult matters and psychology.",
  ...
  },
  {
    ...
    description: "The Ninth House is the house of higher learning, long-distance travel, philosophy, and spiritual seeking. It governs your belief systems, higher education, publishing, and foreign cultures. This house reveals your search for meaning and truth in life.",
  ...
  },
  {
    ...
    rulingPlanet: "Saturn",
    description: "The Tenth House represents your career, public reputation, and highest achievements. It governs your relationship with authority figures (especially the father figure), your professional goals, and how you're seen by the world. This house shows your legacy and social status.",
  ...
  },
  {
    ...
    rulingSign: "Aquarius",
    rulingPlanet: "Uranus",
    description: "The Eleventh House governs friendships, groups, organizations, and your hopes for the future. It reveals your social circle, involvement in communities, and humanitarian interests. This house shows how you contribute to collective goals and what you aspire to achieve.",
  ...
  },
  {
    ...
    description: "The Twelfth House is the house of the unconscious, spirituality, and hidden matters. It governs dreams, secrets, karma, and self-undoing patterns. This mysterious house reveals your spiritual path, hidden strengths, and the things you must release to evolve.",
